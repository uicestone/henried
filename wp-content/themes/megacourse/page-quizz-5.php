			...
			<div class="row">
				<div class="col-md-8">
					<div class="question-content">
						<h4 class="sm">Question 5 - True / false</h4>
						...
						<a href="#" class="mc-btn btn-style-6">Submit and Finish</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<aside class="question-sidebar">
						<div class="score-sb">
							...
							<ul>
								<li class="val"><i class="icon"></i>Question 1<span>20</span></li>
								<li class="val"><i class="icon"></i>Question 2<span>20</span></li>
								<li class="val"><i class="icon"></i>Question 3<span>20</span></li>
								<li class="val"><i class="icon"></i>Question 4<span>20</span></li>
