...
add_action('init', function(){
	...
	wp_register_style('bootstrap', get_stylesheet_directory_uri() . '/css/library/bootstrap.min.css', array(), '3.2.0a');
	...
	wp_register_style('style', get_stylesheet_directory_uri() . '/style.css', array(), '2016-12-22');
