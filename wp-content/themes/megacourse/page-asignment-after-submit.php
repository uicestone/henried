			...
			<div class="row">
				<div class="col-md-8">
					<div class="question-content">
						...
						<div class="asign-notifi">
							<div class="mc-processing notifi-item">
								<div class="inner">
									<i class="fa fa-rotate-right"></i>
									Processing ..
								</div>
							</div>
							<div class="mc-ok notifi-item">
								<div class="inner">
									<i class="fa fa-check"></i>
									You have submitted to the instructor successfully. Your instructor will send result soon
								</div>
							</div>
							<div class="mc-err notifi-item">
								<div class="inner">
									<i class="fa fa-close"></i>
									Sorry! Problem happens, please submit your assignment again !
								</div>
							</div>
						</div>
				...
				<div class="col-md-4">
					<aside class="question-sidebar">
						...
						<div class="score-sb">
							<h4 class="title-sb">Total score<span>60</span></h4>
							<ul>
